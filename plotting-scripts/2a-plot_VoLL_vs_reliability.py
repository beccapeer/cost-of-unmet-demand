"""
file name: plot_VoLL_vs_reliability.py
    plot value of lost load (= cost of unmet demand) against corresponding 
    reliability (= fraction of demand met) for all cases
"""
...
# y-axis (cost of unmet demand) on logarithmic scale

# base case
ax.loglog(100*(1-reliability[0,:]), cost_unmet_demand[0], 
          linestyle='-', linewidth=1.8, color='k')

# all other cases
for i in range(1,nfiles):
    ax.loglog(100*(1-reliability[i,:]), cost_unmet_demand[i], 
...
#fig.savefig(file_path + 'plots/' + '2a-VoLL vs. reliability' + '.png', 
#            dpi=600, bbox_inches='tight', pad_inches=0.2)
#fig.savefig(file_path + 'plots/' + '2a-VoLL vs. reliability' + '.svg', 
#            dpi=600, bbox_inches='tight', pad_inches=0.2)
plt.show()
